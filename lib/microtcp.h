...
#define FIN     1   //0000000000000001
#define SYN     2   //0000000000000010
#define RST     4   //0000000000000100
#define ACK     8   //0000000000001000
#define SYN_ACK 10  //0000000000001010
#define FIN_ACK 9   //0000000000001001
...
void
header_init(microtcp_header_t *header);

void
header_print(microtcp_header_t* header);

void
header_hton(microtcp_header_t* header);

void 
header_ntoh(microtcp_header_t* header);

int 
check_sum(microtcp_header_t* header);

size_t 
min(size_t flow_cntrl_win, size_t cwnd, size_t remaining);
